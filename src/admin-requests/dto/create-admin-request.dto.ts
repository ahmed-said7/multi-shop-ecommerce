...
export class CreateAdminRequestDto {
  ...
  @IsString({
    message: i18nValidationMessage('validation.admin_request.title.isString'),
  })
  title: string;
  // @IsNotEmpty({ message: i18nValidationMessage("validation.admin_request.type.isNotEmpty")})
  @IsEnum(RequestType, {
    message: i18nValidationMessage('validation.admin_request.type.isString'),
  })
  type: RequestType;
  // @IsNotEmpty({ message: i18nValidationMessage("validation.admin_request.description.isNotEmpty")})
  @IsString({
    message: i18nValidationMessage(
      'validation.admin_request.description.isString',
    ),
  })
  description: string;
  ...
  @IsString({
    message: i18nValidationMessage('validation.admin_request.info.isString'),
  })
  info: string;
  // @IsOptional()
  // @IsString()
