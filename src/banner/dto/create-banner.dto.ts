...
export class CreateBannerDto {
  ...
  @IsString({
    message: i18nValidationMessage('validation.banner.title.isString'),
  })
  title: string;

  // @IsNotEmpty({ message : i18nValidationMessage("validation.banner.subTitle.isNotEmpty") })
  @IsString({
    message: i18nValidationMessage('validation.banner.subTitle.isString'),
  })
  subTitle: string;
  ...
  @IsString({
    message: i18nValidationMessage(
      'validation.banner.titleAndSubTitlePosition.isString',
    ),
  })
  ...
  @IsString({
    message: i18nValidationMessage(
      'validation.banner.titleAndSubTitleColor.isString',
    ),
  })
  ...
  @IsString({
    message: i18nValidationMessage('validation.banner.buttonText.isString'),
  })
  buttonText: string;

  // @IsNotEmpty({ message : i18nValidationMessage("validation.banner.buttonLink.isNotEmpty") })
  @IsString({
    message: i18nValidationMessage('validation.banner.buttonLink.isString'),
  })
  buttonLink: string;

  // @IsNotEmpty({ message : i18nValidationMessage("validation.banner.buttonColor.isNotEmpty") })
  @IsString({
    message: i18nValidationMessage('validation.banner.buttonColor.isString'),
  })
  buttonColor: string;
  ...
  @IsString({
    message: i18nValidationMessage(
      'validation.banner.buttonTextColor.isString',
    ),
  })
  ...
  @IsString({
    message: i18nValidationMessage('validation.banner.buttonPosition.isString'),
  })
  buttonPosition: string;

  // @IsNotEmpty({ message : i18nValidationMessage("validation.banner.image.isNotEmpty") })
  @IsString({
    message: i18nValidationMessage('validation.banner.image.isString'),
  })
  image: string;
}
