...
export class AddToCartDto {
  ...
  @IsMongoId({
    message: i18nValidationMessage('validation.cart.itemId.isMongoId'),
  })
  itemId: string;
  @IsOptional()
  @IsNumber(
    {},
    { message: i18nValidationMessage('validation.cart.quantity.isNumber') },
  )
  quantity: number;
  @IsOptional()
  ...
  @IsString({
    message: i18nValidationMessage('validation.cart.color.isString'),
  })
  color: string;
}
